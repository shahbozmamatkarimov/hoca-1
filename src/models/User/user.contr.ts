...
class UserController {
        ...
        try {
            ...
            if (!confirmationCode) {
                ...
                if (confirmationCode !== await getRedisData(email)) {
                    ...
                    const user: IUser = new UserModel({ username, email, role: role ? role : 'user', password: passwordHash });
    ...
    public getUserById = async (req: Request, res: Response): Promise<void> => {
        const { id } = req.params;
        try {
            const user = await UserModel.findById(id).populate("boughtPost likedPost");
            if (!user) {
    ...
    public updateUserByToken = async (req: Request, res: Response): Promise<void> => {
        let {
            password,
        } = req.body;
        try {
    ...
    public login = async (req: Request, res: Response): Promise<void> => {
        ...
        try {
            // Foydalanuvchini em   ail orqali qidirish
